...
const SideBar=()=> {
   ...
   const menus=[
      {name:"Dasboard",link:'/admin/dashboard',icon:GiHamburgerMenu},
      {name:"Job Seeker",link:'/admin/user',icon:FaUserAlt},
      {name:"Recruiter",link:'/admin/recruiter',icon:BsBuildingFill},
      {name:"Jobs",link:'/admin/jobs',icon:BsBagFill},
      {name:"Subscription",link:'/admin/subscription',icon:TbBusinessplan},
   ...
   <div className={`bg-slate-100 min-h-[42.887rem]  ${!isMobile?'w-72':'w-16'}  duration-500 text-gray-700 px-4`}>
      {/* <div className='py-3 flex justify-end'>
            ...
            <div className='mt-4 flex flex-col gap-4 relative'>
               ...
               className="group flex items-center gap-3.5 font-medium p-2 bg-white hover:text-white hover:bg-violet-600 rounded-md">
