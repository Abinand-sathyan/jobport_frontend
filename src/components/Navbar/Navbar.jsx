           ...
           md:opacity-100 opacity-0 top-[-400] transition-all ease-in"
            ...
            <Link to="/contact"><p className="hover:text-siteviolet ">Contact</p></Link>
              ...
              {user ? (
                ...
                <button
                  type="button"
                  className="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-bold rounded-full text-sm px-8 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700"
                  onClick={() => {
                    navigate("/login");
                  }}
                >
