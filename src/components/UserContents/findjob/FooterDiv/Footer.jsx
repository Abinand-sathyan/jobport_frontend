  ...
  return (
    <div>
      <footer aria-label="Site Footer" className="bg-white dark:bg-gray-900">
        <div className="m-auto max-w-screen px-4 py-16 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center gap-4 rounded-lg bg-siteviolet p-6 shadow-lg sm:flex-row sm:justify-between">
